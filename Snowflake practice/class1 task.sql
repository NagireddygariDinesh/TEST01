...
CREATE TABLE customer_address (
    ...
    CA_ADDRESS_ID       VARCHAR(50),
    CA_STREET_NUMBER    VARCHAR(10),
    CA_STREET_NAME      VARCHAR(100),
    CA_STREET_TYPE      VARCHAR(50),
    CA_SUITE_NUMBER     VARCHAR(20),
    CA_CITY             VARCHAR(100),
    CA_COUNTY           VARCHAR(100),
    CA_STATE            VARCHAR(50),
    CA_ZIP              VARCHAR(20),
    CA_COUNTRY          VARCHAR(50),
    CA_GMT_OFFSET       DECIMAL(5,2),
    CA_LOCATION_TYPE    VARCHAR(50)
);
